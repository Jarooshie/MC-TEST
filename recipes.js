...
onEvent("recipes", (event) => {
    ...
    event.remove({ id: "betternether:cincinnasite_anvil" });
    ...
    event.smelting('betternether:quartz_glass', 'byg:raw_quartz_block');

    event.blasting('biggerreactors:yellorium_ingot', 'biggerreactors:yellorite_ore');

    event.blasting('biggerreactors:yellorium_ingot', 'create:crushed_uranium_ore');
